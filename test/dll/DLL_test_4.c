 ...
 * (Token)
 * Modul obsahuje test inicializace pro dynamicky alokovany spojovy seznam s datovym typem Token.
 *
 * @author xramas01 Jakub Ramaseuski
 */

_DLL(test, tok, Token, tok_free)
DLL(test, tok, Token, tok_free)
